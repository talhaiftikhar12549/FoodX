...
import styles from './Navigation.css.esnext';
...
const Navigation = function Navigation({
  ...
  return /*#__PURE__*/React.createElement(NavigationContext.Provider, {
    ...
    className: classNames(styles.Navigation, features?.dynamicTopBarAndReframe && styles['NavigationFrame-TopBarAndReframe']),
    "aria-labelledby": ariaLabelledBy
  }, mdUp || !features?.dynamicTopBarAndReframe ? mediaMarkup : null, /*#__PURE__*/React.createElement(Scrollable, {
    className: classNames(styles.PrimaryNavigation, features?.dynamicTopBarAndReframe && styles['PrimaryNavigation-TopBarAndReframe'])
  }, children))));
};
