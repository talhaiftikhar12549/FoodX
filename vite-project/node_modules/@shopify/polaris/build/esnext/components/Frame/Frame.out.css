...
.Polaris-Frame__hasSidebar--topBarAndReframe_17agm{
...
.Polaris-Frame__Frame--topBarAndReframe_msv4r{
...
.Polaris-Frame__Main--topBarAndReframe_17qnp{
...
.Polaris-Frame--hasTopBar_1162r .Polaris-Frame__Main--topBarAndReframe_17qnp{
...
.Polaris-Frame__Content--topBarAndReframe_vqk3y{
  height:100%;
}

@media screen and (min-width: 1200px){

.Polaris-Frame--hasSidebar_rqyuy .Polaris-Frame__Content--topBarAndReframe_vqk3y{
      margin-right:unset;
  }
    }
...
.Polaris-Frame__ScrollbarSafeArea--topBarAndReframe_ktlhw{
    transition:width var(--p-motion-duration-250) var(--p-motion-ease);
...
.Polaris-Frame--hasSidebar_rqyuy .Polaris-Frame__ScrollbarSafeArea--topBarAndReframe_ktlhw{
    transition:width var(--p-motion-duration-250) var(--p-motion-ease);
  }
...
.Polaris-Frame__ShadowBevel_1hoxq{
  position: relative;
...
.Polaris-Frame__ShadowBevel_1hoxq::before {
  content: "";
  position: absolute;
  top: 0;
  left: 0;
...
.Polaris-Frame--hasSidebar_rqyuy .Polaris-Frame__ShadowBevel_1hoxq{
    transition:width var(--p-motion-duration-250) var(--p-motion-ease);
  }
...
.Polaris-Frame__Scrollable_1ed9o{
  width:100%;
...
.Polaris-Frame__Scrollable_1ed9o:hover{
    scrollbar-color:var(--p-color-scrollbar-thumb-bg-hover) transparent;
  }

.Polaris-Frame__Scrollable--scrollbarAlwaysVisible_xagry::-webkit-scrollbar{
    width:0.6875rem;
    background-color:var(--p-color-bg);
  }

.Polaris-Frame__Scrollable--scrollbarAlwaysVisible_xagry::-webkit-scrollbar-thumb{
...
.Polaris-Frame__Scrollable--scrollbarAlwaysVisible_xagry::-webkit-scrollbar-thumb:hover{
