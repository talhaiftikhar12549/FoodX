...
const Navigation = function Navigation({
  ...
  const features = hooks$1.useFeatures();
  const {
    mdUp
  ...
  return /*#__PURE__*/React.createElement(context.NavigationContext.Provider, {
    ...
    className: css.classNames(Navigation_module.default.Navigation, features?.dynamicTopBarAndReframe && Navigation_module.default['NavigationFrame-TopBarAndReframe']),
    "aria-labelledby": ariaLabelledBy
  }, mdUp || !features?.dynamicTopBarAndReframe ? mediaMarkup : null, /*#__PURE__*/React.createElement(Scrollable.Scrollable, {
    className: css.classNames(Navigation_module.default.PrimaryNavigation, features?.dynamicTopBarAndReframe && Navigation_module.default['PrimaryNavigation-TopBarAndReframe'])
  }, children))));
};
