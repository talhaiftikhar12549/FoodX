...
class FrameInner extends React.PureComponent {
  ...
  render() {
    ...
    const getFrameClassName = hasDynamicTopBar => css.classNames(Frame_module.default.Frame, hasDynamicTopBar && Frame_module.default['Frame-TopBarAndReframe'], navigation && Frame_module.default.hasNav, topBar && Frame_module.default.hasTopBar, sidebar && Frame_module.default.hasSidebar, sidebar && hasDynamicTopBar && Frame_module.default['hasSidebar-TopBarAndReframe'], this.state.scrollbarAlwaysVisible && Frame_module.default.ScrollbarAlwaysVisible);
    const contextualSaveBarMarkup = this.props.dynamicTopBarAndReframe ? /*#__PURE__*/React.createElement(React.Fragment, null) : /*#__PURE__*/React.createElement(CSSAnimation.CSSAnimation, {
    ...
    const hasDynamicTopBar = this.props.dynamicTopBarAndReframe && Boolean(topBar);
    return /*#__PURE__*/React.createElement(context.FrameContext.Provider, {
      value: context$1
    }, /*#__PURE__*/React.createElement("div", Object.assign({
      className: getFrameClassName(hasDynamicTopBar)
    }, shared.layer.props, navigationAttributes), skipMarkup, topBarMarkup, hasDynamicTopBar ? null : navigationMarkup, contextualSaveBarMarkup, loadingMarkup, navigationOverlayMarkup, hasDynamicTopBar ? /*#__PURE__*/React.createElement("div", {
      className: Frame_module.default.ShadowBevel,
      id: APP_FRAME_BEVEL
    }, navigationMarkup, /*#__PURE__*/React.createElement("main", {
      className: css.classNames(Frame_module.default.Main, Frame_module.default['Main-TopBarAndReframe']),
      id: APP_FRAME_MAIN,
      "data-has-global-ribbon": Boolean(globalRibbon)
    }, hasDynamicTopBar ? /*#__PURE__*/React.createElement(Scrollable.Scrollable, {
      scrollbarWidth: "thin",
      horizontal: false,
      className: css.classNames(Frame_module.default.Scrollable, this.state.scrollbarAlwaysVisible && Frame_module.default['Scrollable-ScrollbarAlwaysVisible']),
      id: APP_FRAME_SCROLLABLE
    }, /*#__PURE__*/React.createElement("div", {
      className: css.classNames(Frame_module.default.Content, Frame_module.default['Content-TopBarAndReframe'])
    }, /*#__PURE__*/React.createElement("div", {
      className: Frame_module.default['ScrollbarSafeArea-TopBarAndReframe']
    }, children))) : /*#__PURE__*/React.createElement("div", {
      className: Frame_module.default.Content
    }, children))) : /*#__PURE__*/React.createElement("main", {
...
function Frame(props) {
  ...
  return /*#__PURE__*/React.createElement(hooks$2.UseFeatures, null, ({
    dynamicTopBarAndReframe
  }) => /*#__PURE__*/React.createElement(FrameInner, Object.assign({}, props, {
    i18n: i18n,
